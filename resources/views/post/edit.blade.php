...
<div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- /.card -->
        <form method="POST" id="event-form" action="{{ route('post.update',[app()->getlocale(),$post->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="writerName" name="writerName" value="{{ $post->writerName }}">
                                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="writerEmail" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="{{ $post->writerEmail }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="card-body pad">
                          <div class="mb-3">
                            <textarea class="textarea" placeholder="Place some text here"
                                      style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="body" name="body">{{ $post->body }}</textarea>
                          </div>
                        </div>
                    </div>
                </div>
