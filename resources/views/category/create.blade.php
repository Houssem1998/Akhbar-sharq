...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <form method="POST" id="event-form" action="{{ route('category.store',app()->getlocale()) }}" enctype="multipart/form-data">
                @csrf
                <h3 class="card-title">Create a Category</h3>
                <div class="form-group">
                    <br /><br />
                    <input type="text" class="form-control" placeholder="Enter category title here" id="name" name="name" value="{{ old('name') }}">
                </div>
